...
**Cruise power:** L/D ≈ 11 (clean tailless) → drag 17.5/11 = 1.6 N × 14.5 m/s
= 23 W aero ÷ (0.62 prop × 0.85 motor) ≈ **43 W** + 10 W avionics = **~53 W**.

**Endurance: 184 Wh ÷ 53 W ≈ 3.5 h · range ≈ 170 km still air.**
...
- Solar system ≈ +300 g → AUW ~2.08 kg → cruise ~63 W
- **Net midday draw: 63 − 44 ≈ 19 W → endurance stretches toward 8–10 h** in
...
- Wing segments in LW-PLA standing up; body + hatch in PETG; winglets/elevons LW-PLA.
